  ...
  return (
    <div className="relative h-48 w-48">
      <div className="absolute top-0 flex w-full justify-center">
        <div className="animate-border-width left-0 h-[1px] rounded-full bg-gradient-to-r from-[rgba(17,17,17,0)] via-white to-[rgba(17,17,17,0)] transition-all duration-1000" />
      </div>
